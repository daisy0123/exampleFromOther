...
?>
    <input type="button" name="Submit" value="..." title="从已上传文件中选择" onClick="javascript:window.open('editor_SelectUpFile.php?DialogType=flash', 'selupfile', 'width=800, height=600, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=yes');">
<?php
}
?>
	</td></TR>
...
<iframe class="TBGen" style="top:2px" ID="UploadFiles" src="upload_dialog.php?DialogType=flash" frameborder=0 scrolling=no width="350" height="25"></iframe>
</fieldset>
	</td>
