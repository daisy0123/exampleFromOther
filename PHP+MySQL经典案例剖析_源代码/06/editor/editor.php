...
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_cr.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertTable()'>插入表格</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_sx.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tableProp()'>表格属性</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_sx2.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='cellProp()'>单元格属性</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_tr.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(1)'>插入一行</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_trdel.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(2)'>删除一行</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_td.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(3)'>插入一列</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_tddel.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(4)'>删除一列</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_hby.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(5)'>向右合并</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_hbx.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(6)'>向下合并</a></td></tr>";
menu_table+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/table_cf.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='tablecommand(7)'>拆分单元格</a></td></tr>";
menu_table+="</table>";
var menu_chars="<table width='100%' cellspacing='0' cellpadding='2'>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars1.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(0)'>换行符</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars2.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(1)'>版权符号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars3.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(2)'>注册商标</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars4.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(3)'>商标符号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars5.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(4)'>圆点</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars6.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(5)'>省略号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars7.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(6)'>破折号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/chars8.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(7)'>中划线</a></td></tr>";
menu_chars+="</table>";
var menu_eq="<table width='100%' cellspacing='0' cellpadding='2'>";
menu_eq+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/eq1.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertEQ()'>插入公式</a></td></tr>";
menu_eq+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='../editor/Editorimages/eq2.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InstallEQ()'>安装公式编辑器插件</a></td></tr>";
menu_eq+="</table>";
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="全部选择" LANGUAGE="javascript" onClick="format('selectall')"> 
    <img class="Ico" src="../editor/Editorimages/selectall.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="删除" LANGUAGE="javascript" onClick="format('delete')"> 
    <img class="Ico" src="../editor/Editorimages/del.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onClick="format('cut')"> <img class="Ico" src="../editor/Editorimages/cut.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="复制" LANGUAGE="javascript" onClick="format('copy')"> 
    <img class="Ico" src="../editor/Editorimages/copy.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="粘贴" LANGUAGE="javascript" onClick="format('paste')"> 
    <img class="Ico" src="../editor/Editorimages/paste.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="从word中粘贴" LANGUAGE="javascript" onClick="word()"> <img class="Ico" src="../editor/Editorimages/wordpaste.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="撤消" LANGUAGE="javascript" onClick="format('undo')"> 
    <img class="Ico" src="../editor/Editorimages/undo.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="恢复" LANGUAGE="javascript" onClick="format('redo')"> 
    <img class="Ico" src="../editor/Editorimages/redo.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查找"	LANGUAGE="javascript" onClick="findstr()"> <img class="Ico" src="../editor/Editorimages/find.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="计算器" LANGUAGE="javascript" onClick="calculator()"> <img class="Ico" src="../editor/Editorimages/calculator.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <!--  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="save()"> <img class="Ico" src="../editor/Editorimages/save.gif" WIDTH="18" HEIGHT="18"> 
  </div> //-->
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onClick="help()"><img class="Ico" src="../editor/Editorimages/help.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <iframe class="TBGen" style="top:2px" ID="UploadFiles" src="upload_article.htm" frameborder=0 scrolling=no width="250" height="25"></iframe>
</div>
...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onClick="foreColor()"> <img class="Ico" src="../editor/Editorimages/fgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="文字背景色" LANGUAGE="javascript" onClick="backColor()"> 
    <img class="Ico" src="../editor/Editorimages/fgbgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="加粗" LANGUAGE="javascript" onClick="format('bold')"> 
    <img class="Ico" src="../editor/Editorimages/bold.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="斜体" LANGUAGE="javascript" onClick="format('italic')"> 
    <img class="Ico" src="../editor/Editorimages/italic.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="下划线" LANGUAGE="javascript" onClick="format('underline')"> 
    <img class="Ico" src="../editor/Editorimages/underline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="左对齐" NAME="Justify" LANGUAGE="javascript" onClick="format('justifyleft')"> 
    <img class="Ico" src="../editor/Editorimages/Aleft.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="居中" NAME="Justify" LANGUAGE="javascript" onClick="format('justifycenter')"> 
    <img class="Ico" src="../editor/Editorimages/Acenter.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="右对齐" NAME="Justify" LANGUAGE="javascript" onClick="format('justifyright')"> 
    <img class="Ico" src="../editor/Editorimages/Aright.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="上标" LANGUAGE="javascript" onClick="format('superscript')"> 
    <img class="Ico" src="../editor/Editorimages/sup.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="下标" LANGUAGE="javascript" onClick="format('subscript')"> 
    <img class="Ico" src="../editor/Editorimages/sub.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="删除文字格式" LANGUAGE="javascript" onClick="format('RemoveFormat')"> 
    <img class="Ico" src="../editor/Editorimages/clear.gif" WIDTH="18" HEIGHT="18"> 
  </div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  <div class="Btn" TITLE="编号" LANGUAGE="javascript" onClick="format('insertorderedlist')"> 
    <img class="Ico" src="../editor/Editorimages/num.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="项目符号" LANGUAGE="javascript" onClick="format('insertunorderedlist')"> 
    <img class="Ico" src="../editor/Editorimages/list.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="减少缩进量" LANGUAGE="javascript" onClick="format('outdent')"> 
    <img class="Ico" src="../editor/Editorimages/outdent.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="增加缩进量" LANGUAGE="javascript" onClick="format('indent')"> 
    <img class="Ico" src="../editor/Editorimages/indent.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onClick="UserDialog('CreateLink')"> 
    <img class="Ico" src="../editor/Editorimages/url.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onClick="UserDialog('unLink')"> 
    <img class="Ico" src="../editor/Editorimages/nourl.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onClick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="../editor/Editorimages/line.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onClick="hr()"><img class="Ico" src="../editor/Editorimages/sline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入手动分页符" LANGUAGE="javascript" onClick="page()"><img class="Ico" src="../editor/Editorimages/page.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入当前日期" LANGUAGE="javascript" onClick="nowdate()"> <img class="Ico" src="../editor/Editorimages/date.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入当前时间" LANGUAGE="javascript" onClick="nowtime()"> <img class="Ico" src="../editor/Editorimages/time.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onClick="FIELDSET()"><img class="Ico" src="../editor/Editorimages/fieldset.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onClick="iframe()"><img class="Ico" src="../editor/Editorimages/htm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入Excel表格" LANGUAGE="javascript" onClick="excel()"> 
    <img class="Ico" src="../editor/Editorimages/excel.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入表格" LANGUAGE="javascript" onClick="InsertTable()"> 
    <img class="Ico" src="../editor/Editorimages/table.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="BtnMenu" TITLE="表格操作" LANGUAGE="javascript" onClick="ShowMenu(menu_table,100)"> 
    <img class="Ico" src="../editor/Editorimages/arrow.gif" WIDTH="5" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入换行符号" LANGUAGE="javascript" onClick="InsertChars(0)"> 
    <img class="Ico" src="../editor/Editorimages/chars.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="BtnMenu" TITLE="更多特殊符号" LANGUAGE="javascript" onClick="ShowMenu(menu_chars,100)"> 
    <img class="Ico" src="../editor/Editorimages/arrow.gif" WIDTH="5" HEIGHT="18"> 
  </div>
  <!--
  <div class="Btn" TITLE="插入公式" LANGUAGE="javascript" onclick="InsertEQ()"> <img class="Ico" src="../editor/Editorimages/eq.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="BtnMenu" TITLE="公式操作" LANGUAGE="javascript" onclick="ShowMenu(menu_eq,100)"> 
	<img class="Ico" src="../editor/Editorimages/arrow.gif" WIDTH="5" HEIGHT="18"> 
  </div>
  //-->
  <div class="Btn" TITLE="插入图片，支持格式为：jpg、gif、bmp、png等" LANGUAGE="javascript" onClick="pic()"><img class="Ico" src="../editor/Editorimages/img.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onClick="swf()"> 
    <img class="Ico" src="../editor/Editorimages/flash.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onClick="wmv()"> 
    <img class="Ico" src="../editor/Editorimages/wmv.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onClick="rm()"> 
    <img class="Ico" src="../editor/Editorimages/rm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
</div>
<?php
if ($req_usertype == "User"){
?>
<iframe class="HtmlEdit" ID="HtmlEdit" src="User_ArticleContent.asp?Action=<?php echo $req_action ?>&ArticleID=<?php echo $articleid ?>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=296;"> 
</iframe>
<?php
}
else{
?>
<iframe class="HtmlEdit" ID="HtmlEdit" src="../admin/<?php echo $req_dir ?>/EditContent.php?action=<?php echo $req_action ?>&<?php echo $_SERVER['QUERY_STRING'] ?>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=296;"> 
</iframe>
<?php
}
?>
<iframe class="HtmlEdit" ID="HtmlPreview" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=296; display:none"> 
</iframe>
<img id="setMode0" src="../editor/Editorimages/Editor2.gif" width="59" height="20" onClick="setMode(0)">
<img id="setMode1" src="../editor/Editorimages/html.gif" width="59" height="20" onClick="setMode(1)">
<img id="setMode2" src="../editor/Editorimages/browse.gif" width="59" height="20" onClick="setMode(2)">
...
function setMode(newMode)
{
  ...
  if (newMode==0)
  {
	setMode0.src="../editor/Editorimages/Editor2.gif";
	setMode1.src="../editor/Editorimages/html.gif";
	setMode2.src="../editor/Editorimages/browse.gif";
	if (PreviewMode){
  ...
  {
	setMode0.src="../editor/Editorimages/Editor.gif";
	setMode1.src="../editor/Editorimages/html2.gif";
	setMode2.src="../editor/Editorimages/browse.gif";
	if (PreviewMode){
	  document.all.HtmlEdit.style.display="";
	  document.all.HtmlPreview.style.display="none";
  ...
  else if (newMode==2)
  {
	setMode0.src="../editor/Editorimages/Editor.gif";
	setMode1.src="../editor/Editorimages/html.gif";
	setMode2.src="../editor/Editorimages/browse2.gif";
...
function foreColor()
{
  ...
  var arr = showModalDialog("editor_selcolor.htm", "", "dialogWidth:18.5em; dialogHeight:17.5em; help: no; scroll: no; status: no");
...
function InsertTable()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertTable.htm", "", "dialogWidth:450px;dialogHeight:200px;help: no; scroll: no; status: no");
...
function FIELDSET()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_fieldset.htm", "", "dialogWidth:25em; dialogHeight:12.5em; help: no; scroll: no; status: no");
  if (arr != null){
    range.pasteHTML(arr);
  }
  HtmlEdit.focus();
...
function iframe()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertIframe.htm", "", "dialogWidth:30em; dialogHeight:12em; help: no; scroll: no; status: no");  
  if (arr != null){
    range.pasteHTML(arr);
  }
  HtmlEdit.focus();
...
function hr()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertHR.htm", "", "dialogWidth:30em; dialogHeight:12em; help: no; scroll: no; status: no"); 
  if (arr != null){
    range.pasteHTML(arr);
  }
  HtmlEdit.focus();
...
function pic()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertPic.php", "", "dialogWidth:31em; dialogHeight:17em; help: no; scroll: no; status: no");  
  if (arr != null){
    var ss=arr.split("$$$");
...
function swf()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertFlash.php", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no"); 
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
...
function wmv()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertMedia.php", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no");
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
...
function rm()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertRM.php", "", "dialogWidth:31em; dialogHeight:12em; help: no; scroll: no; status: no");  
  if (arr != null){
    var ss=arr.split("$$$");
    range.pasteHTML(ss[0]);
    parent.myform.IncludePic.checked=true;
...
{
  if (!	validateMode())	return;
  var arr = showModalDialog("editor_find.htm", window, "dialogWidth:420px; dialogHeight:125px; help: no; scroll: no; status: no");
}

function help()
{
  var arr = showModalDialog("editor_help.htm", "", "dialogWidth:580px; dialogHeight:460px; help: no; scroll: no; status: no");
}

function save()
{
	content = window.open("","content","resizable=yes,scrollbars=yes,menubar=yes")
	content.document.write(HtmlEdit.document.body.innerHTML);
	content.focus();
	if (content.document.execCommand){
...
//编辑器嵌入其他网页时使用下面这一句（请将form1改成相应表单名）
    parent.myform.SaveContent.value=HtmlEdit.document.body.innerHTML;
//单独打开编辑器时使用下面这一句（请将form1改成相应表单名）  
//  self.opener.form1.content.value+=HtmlEdit.document.body.innerHTML;
  }
  else if(CurrentMode==1){
//编辑器嵌入其他网页时使用下面这一句（请将form1改成相应表单名）
    parent.myform.SaveContent.value=HtmlEdit.document.body.innerText;
//单独打开编辑器时使用下面这一句（请将form1改成相应表单名）  
...
function tableProp(){
	...
	if(tableflag==true){
		...
		tableiscancel="";
		window.showModalDialog("editor_tableprops.htm",window," dialogWidth: 350px; dialogHeight: 300px; help: no;scroll: no; status: no");
		if(tableiscancel=="no"){
...
function cellProp(){
	...
	if(cellflag==true){
		...
		if(xsel.bgColor!=""&&xsel.bgColor!=null){tablebackgroundcolor=xsel.bgColor;}else{tablebackgroundcolor="";}
		tableiscancel="";
		window.showModalDialog("editor_cellprops.htm",window,"dialogWidth: 400px; dialogHeight: 230px;help: no;scroll: no; status: no");
		if(tableiscancel=="no"){
			if(tablewidthspecified=="yes"){
				var tw1="";
...
function InsertEQ()
{
  HtmlEdit.focus();
  var range =HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_InsertEQ.php", "", "dialogWidth:40em; dialogHeight:20em; status:0;help:0");
...
function InstallEQ()
{
  window.open ("editor_InsertEQ.php?Action=Install", "", "height=200, width=300,left="+(screen.AvailWidth-300)/2+",top="+(screen.AvailHeight-200)/2+", toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no")
}
function calculator()
{
  HtmlEdit.focus();
  var range =HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("editor_calculator.htm", "", "dialogWidth:205px; dialogHeight:210px; status:0;help:0");
