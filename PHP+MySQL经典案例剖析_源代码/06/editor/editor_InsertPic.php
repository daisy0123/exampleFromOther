...
function OK(){
  ...
  else
  {
    ...
    str1=str1+" onload=\"javascript:if(this.width>740)this.width=740\">";
...
<tr>
  <td colspan="2">图片地址：
    <input name="url" id="url" value='http://' size=38 maxlength="200">
              <input type="button" name="Submit" value="..." title="从已上传文件中选择" onClick="javascript:window.open('editor_SelectUpFile.php?DialogType=pic', 'selupfile', 'width=800, height=600, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=yes');">
            </td>
  </tr><tr>
          <td> 说明文字：
...
<iframe class="TBGen" style="top:2px" ID="UploadFiles" src="upload_dialog.php?DialogType=pic" frameborder=0 scrolling=no width="350" height="25"></iframe>
</fieldset>
	</td>
