...
<input type="submit" name="Submit2" value=" 搜 索 ">
	...
	<p class="STYLE2">5、查询我的订单 当前登录用户：{*if $_TPL[SESSION][User][F_ID]*} {*$_TPL[SESSION][User][F_LOGIN_NAME]*}<a href="/Login/LoginOut">[退出登录]</a> {*else*} <a href="/Login">您未登录</a><a href="/Login/ForgetPwd">[忘记密码]</a> {*/if*}</p>
