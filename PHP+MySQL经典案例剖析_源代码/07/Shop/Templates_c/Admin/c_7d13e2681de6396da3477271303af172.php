...
<?php echo $this->_vars['uu']['prev']; ?>

<?php if ($this->_vars['uu']['sub_num'] > 0): ?>	
<img src="/images/plus.gif" />
<?php else: ?>
<img src="/images/nofollow.gif" />
<?php endif; ?>
<a href="<?php echo $this->_vars['url'];  echo $this->_vars['uu']['id']; ?>
" target='main'><?php echo $this->_vars['uu']['class_name']; ?>
</a> <br />
