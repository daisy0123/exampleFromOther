...
<form action="/Config/<?php echo $this->_vars['action']; ?>
  ...
  <tr>
		...
		<table width="80%" border="0" align="center">
		  <tr>
	  		...
	  		<td width="82%"><?php echo $this->_vars['info']['F_CONFIG_NAME']; ?>
</td>
	 </tr>
	 <tr>
	  		<td align="right">配置项<font color="red">*</font></td>
	  <td><input name="note" type="text" id="note" value="<?php echo $this->_vars['info']['F_CONFIG_NOTE']; ?>
">
			  最多100个字符</td>
	 </tr>
	 <tr>
	  		<td align="right">设置值<font color="red">*</font></td>
	  		<td><input name="value" type="text" id="value" value="<?php echo $this->_vars['info']['F_CONFIG_VALUE']; ?>
">
			  设置值数字</td>
	 </tr>
	</table>
