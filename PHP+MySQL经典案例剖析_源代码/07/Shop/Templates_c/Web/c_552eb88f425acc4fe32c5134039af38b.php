    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="195" align="left" valign="top"><h2>帐号：</h2></td>
                <td width="505" align="left"><?php if ($this->_vars['error']['NAME_MSG']): ?>
                    <div class="reg_error"> <?php endif; ?>
                        <input name="name" type="text" id="name" size="40" value="<?php echo $this->_vars['error']['NAME_VALUE']; ?>
" /><br />&lt;A-Z字母,0-9数字,下划线_组成,长度3-18个字符&gt;
                        <?php if ($this->_vars['error']['NAME_MSG']): ?>
            ...
            <tr>
              <td width="195" align="left"><h2>激活邮箱：</h2></td>
                <td width="505" align="left"><?php if ($this->_vars['error']['MAIL_MSG']): ?>
                    <div class="reg_error"> <?php endif; ?>
                        <input name="email" type="text" id="email" size="40" value="<?php echo $this->_vars['error']['MAIL_VALUE']; ?>
"/>
                        <?php if ($this->_vars['error']['MAIL_MSG']): ?>
                        <div><?php echo $this->_vars['error']['MAIL_MSG']; ?>
</div>
                    </div>
              <?php endif; ?> </td>
            </tr>
            ...
            <tr>
              <td width="195" align="left"><h2>登录密码：</h2></td>
                <td width="505" align="left"><?php if ($this->_vars['error']['PASS_MSG']): ?>
                    <div class="reg_error"> <?php endif; ?>
                        <input name="password" type="password" id="password" value="<?php echo $this->_vars['error']['PASS_VALUE']; ?>
" size="40" /><br />&lt;密码长度请在6-20位之间&gt;
                        <?php if ($this->_vars['error']['PASS_MSG']): ?> 
            ...
            <tr>
              <td width="195" align="left"><h2>确认密码：</h2></td>
                <td width="505" align="left"><?php if ($this->_vars['error']['CNFM_MSG']): ?>
                    <div class="reg_error"> <?php endif; ?>
                        <input name="rpassword" type="password" id="rpassword" value="<?php echo $this->_vars['error']['CNFM_VALUE']; ?>
" size="40" />
                        <?php if ($this->_vars['error']['CNFM_MSG']): ?>
                        <div><?php echo $this->_vars['error']['CNFM_MSG']; ?>
</div>
                    </div>
              <?php endif; ?> </td>
            </tr>
...
否</td>
            ...
            <tr>
              <td width="195" align="left"><h2>验证码：</h2></td>
                <td width="505" align="left"><?php if ($this->_vars['error']['VRFY_MSG']): ?>
                    <div class="reg_error">
                    <?php endif; ?>
