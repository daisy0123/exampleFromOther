...
<tr bgColor=#e3e3e3>
<td height=25><?php echo $this->_vars['uu']['F_PRODUCT_NAME']; ?>
</td>
<td align=middle height=25><?php echo $this->_vars['uu']['F_CART_PRODUCT_COUNT']; ?>
</td>
...
<tr bgColor=#e3e3e3>
<td height=25 colspan="3"><b>总计：<?php echo $this->_vars['sum']; ?>
元</b></td>
</tr>
</table>
...
<td width="74%" bgcolor="#FAFAFA"><input name="name" type="text" id="name" size="20" value="<?php echo $this->_vars['info']['F_USER_TRUENAME']; ?>
">
<span class="STYLE1">*</span> 请输入联系人姓名 </td>
</tr>
<tr>
<td align="right" bgcolor="#EEEEEE">联系地址：</td>
<td bgcolor="#FAFAFA"><input name="address" type="text" id="address" size="50" value="<?php echo $this->_vars['info']['F_USER_ADDRESS']; ?>
">
<span class="STYLE1">*</span> 请输入详细地址</td>
</tr>
<tr>
<td height="22" align="right" bgcolor="#EEEEEE">邮政编码：</td>
<td bgcolor="#FAFAFA"><input name="zipcode" type="text" id="zipcode" size="20" value="<?php echo $this->_vars['info']['F_USER_ZIPCODE']; ?>
">
<span class="STYLE1">*</span> 请输入邮政编码</td>
</tr>
<tr>
<td align="right" bgcolor="#EEEEEE">联系电话：</td>
<td bgcolor="#FAFAFA"><input name="phone" type="text" id="phone" size="50" value="<?php echo $this->_vars['info']['F_USER_PHONE']; ?>
">
<span class="STYLE1">*</span> 请输入联系电话</td>
</tr>
<tr>
<td align="right" bgcolor="#EEEEEE">家庭电话：</td>
<td bgcolor="#FAFAFA"><input name="home_phone" type="text" id="home_phone" size="50" value="<?php echo $this->_vars['info']['F_USER_HOME_PHONE']; ?>
">
请输入家庭电话</td>
</tr>
...
<td bgcolor="#FAFAFA"><input name="mobile" type="text" id="mobile" size="20" value="<?php echo $this->_vars['info']['F_USER_MOBILE']; ?>
">                    
请输入联系人的手机号码 </td>
</tr>
<?php if ($this->_vars['info']['F_USER_TRUENAME'] == ''): ?>
<tr>
