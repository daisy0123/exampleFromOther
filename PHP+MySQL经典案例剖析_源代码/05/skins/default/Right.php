...
?>
<div id="blog">
<h2><?php echo $blog_info['F_BLOG_NAME']?></h2>
<?php echo $blog_info['F_BLOG_DESCRIPTION']?>
</div>
<div id="user">
<div id="head">
<img src="<?php												//显示博客主头像
if($user_info['F_USER_HEAD']) 
	echo UPLOAD_DIR . $user_info['F_USER_HEAD'];
else 
...
<h2>搜索</h2>
<div id="keyword"><input type="text" name="Keywords" /><input type="submit" name="Submit" value="提交" />
  <input name="BlogId" type="hidden" id="BlogId" value="<?php echo $blogid?>" />
</div>
</form>
</div>
<div id="rss">
<a href="/rss/Rss.php?BlogId=<?php echo $blogid?>"><img src="/images/feed.png" border="0"></a>
</div>
