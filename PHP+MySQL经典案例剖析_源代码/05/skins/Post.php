...
if($info['F_POSTS_IS_COMMENTED'] AND $blog_info['F_BLOG_COMMENTS'])//判断该博客和文章是否可评论
{
...
<div id="info">分类:<a href='/Index.php?BlogId=<?php echo $blogid?>&Cat=<?php echo $info['CatId']?>'><?php echo $value['F_CATEGORIES_NAME']?></a>
<?php
if($info['F_POSTS_IS_COMMENTED'] AND $blog_info['F_BLOG_COMMENTS'])
{														//判断该文章和该博客是否可以评论
?>
...
<div id="comments">
<form name="form1" method="post" action="/Index.php?BlogId=<?php echo $blogid?>&Action=Comments&ReturnUrl=' + encodeURIComponent(location.pathname) + '" onSubmit="javascript:return check();">
<div id="comment_user">
<?php
...
<div id="verify"><img src="<?php echo INCLUDE_PATH?>GetVerifyImg.php" name="getcode"  height="20" weight="60" border="1" onClick="javascript:this.src='<?php echo INCLUDE_PATH?>GetVerifyImg.php';"></div>
<div id="submit">
