...
<a target=right href="UserAdd.php">新增用户</a><br>
<a target=right href="UserList.php">用户列表</a><br>
<br></td></tr>
</tbody></table></td></tr>
<tr>
<td>
<table width=98% align=center cellspacing=1 cellpadding=4 class=i_table><tr>
  <td class=head>
<a style="float:right" href="#" onClick="return IndexDeploy('a1',2)"><img src="/images/cate_fold.gif" width="14" height="14" border=0 id="img_a1"></a>
<b>科目管理</b></td>
</tr>
<tbody id="cate_a1" style="">
<tr>
  <td class=left_padding>
<a target=right href="ClassAdd.php">新增科目</a><br>
<a target=right href="ClassList.php">科目列表</a><br>
<br></td></tr>
</tbody></table></td></tr>
<tr>
<td>
<table width=98% align=center cellspacing=1 cellpadding=4 class=i_table><tr>
  <td class=head>
<a style="float:right" href="#" onClick="return IndexDeploy('a2',2)"><img src="/images/cate_fold.gif" width="14" height="14" border=0 id="img_a2"></a>
<b>题库管理</b></td>
</tr>
<tbody id="cate_a2" style="">
<tr>
  <td class=left_padding>
<a target=right href="DataBaseAdd.php">新增题库</a><br>
<a target=right href="DataBaseList.php">题库列表</a><br>
<br></td></tr>
</tbody></table></td></tr>
